...
async function addDateOfBirth() {
  try {
    console.log('📋 Running migration: Add date_of_birth to physician_reports...\n');
    
    const migrationPath = path.join(__dirname, '..', 'database', 'migration_add_date_of_birth.sql');
    ...
    console.log('✅ date_of_birth field has been added to physician_reports table');
    process.exit(0);
  } catch (error) {
